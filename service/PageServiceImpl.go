...
func (service PageServiceImpl) Show(ctx context.Context, request web.PageRequest) (web.PageResponse, error) {
	...
	page, err := service.PageRepository.Show(ctx, tx, request.Username)
	if err != nil {
		return web.PageResponse{}, err
	}
